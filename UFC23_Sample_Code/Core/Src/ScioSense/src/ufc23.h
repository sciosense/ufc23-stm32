...
class UFC23 : public ScioSense_Ufc23
{
    ...
    public:
        ...
        float           getTofLsbNs                         (uint8_t batchIndex);                                                               // Returns the LSB of the time of Flight raw measurements in nanoseconds for the indicated batch index
    ...
    public:
        ...
        uint8_t         getAmplitudeMeasurementResultsAfterPgaV (UFC23_AMP_V_TypeDef* amplitudesVUp, UFC23_AMP_V_TypeDef* amplitudesVDn);       // Parse the amplitude results after the PGA from the last update in volts. Returns the amount of valid amplitude measurements                                                                                                                                                                                                                                                                                  
